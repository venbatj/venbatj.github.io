...
use Rnt\Masters\InventoryMoveRepository as CR;
...
class InventoryMove
{
    ...
    {
        if (CR::isExists($Req))
            return Utils::errorResponse('InventoryMove "'.$Req['InventoryMove'].'" already exists!');
    ...
    {   
        $Columns = array('', 'InventoryMove', 'Description');
