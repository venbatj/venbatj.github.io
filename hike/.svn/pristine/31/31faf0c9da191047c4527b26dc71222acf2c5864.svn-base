...
use Rnt\Masters\OrderInventoryTypeRepository as CR;
...
class OrderInventoryType
{
     ...
     * @return array
     */
    public static function getDeliveryData()
    {
        return Utils::response(CR::getDeliveryData(), true);
    }
     ...
     * @return array
     */
    public static function getOrderTypeForORderRFID()
    {
        return Utils::response(CR::getOrderTypeForORderRFID(), true);
    }

    /**
     * Insert / Update OrderInventoryType
     * @param array $Req
     * @return array
     */
    ...
    {
        if (CR::isExists($Req))
            return Utils::errorResponse('Order Inventory Type "'.$Req['OrderType'].'" already exists!');
    ...
    {   
        $Columns = array('', 'OrderType', 'Description');
