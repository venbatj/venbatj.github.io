 ...
 * @package Rnt\Masters
 */
class QuoteTypeRepository implements IRepository
{
    use AERRepository;
    ...
    {
        $Obj = new SqlManager();
        $Obj->addTbls('QuoteType');
        $Obj->addFlds(array('ID', 'QuoteType'));
        $Obj->addOrderFlds('QuoteType', 'ASC');
    ...
    public static function getDataByID($ID)
    {
        $Obj = new SqlManager();
        $Obj->addTbls('QuoteType');
        $Obj->addFlds(array('ID', 'QuoteType', 'Description'));
    ...
    public static function isExists($Row)
    {
        ...
        $Obj->addFldCond('QuoteType', $Row['QuoteType']);    
        $Obj->addFldCond('Flag', 'R', '!=');
	...
	public static function getDataTblListCount($SearchTxt) 
	{
		...
		$Obj->addFldCond('Flag', 'R', '!=');
		if ($SearchTxt != '') {
			$Obj->addFldCond('QuoteType', "%{$SearchTxt}%", 'LIKE', 'AND', '(');
