...
class CategoryRepository implements IRepository
{
    ...
    public static function getAllData()
    {
        ...
        $Obj->addFlds(array('ID', 'CategoryName'));
        $Obj->addOrderFlds('CategoryName', 'ASC');
    ...
    public static function getDataByID($ID)
    {
        $Obj = new SqlManager();
        $Obj->addTbls('Category');
        $Obj->addFlds(array('ID', 'OstID', 'CategoryName', 'Description'));
    ...
    public static function isExists($Row)
    {
        ...
        $Obj->addFldCond('CategoryName', $Row['CategoryName']);    
        $Obj->addFldCond('Flag', 'R', '!=');
	...
	public static function getDataTblList($Index, $Limit, $SearchTxt = '', $OrderFld = '', $OrderType = '')
	{
		$Obj = new SqlManager();
		$Obj->addTbls('Category');
		$Obj->addFlds(array('ID', 'CategoryName', 'Description'));
		$Obj->addFldCond('Flag', 'R', '!=');
		if ($SearchTxt != '') {
            $Obj->addFldCond('CategoryName', "%{$SearchTxt}%", 'LIKE', 'AND', '(');
            $Obj->addFldCond('Description', "%{$SearchTxt}%", 'LIKE', 'OR', '', ')');
