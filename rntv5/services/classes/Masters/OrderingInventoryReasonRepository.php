...
/**
 * OrderingInventoryReasonRepository
 * 
 * @package Rnt\Masters
 */
class OrderingInventoryReasonRepository implements IRepository
{
    use AERRepository;
    ...
    {
        $Obj = new SqlManager();
        $Obj->addTbls('OrderingReason');
        $Obj->addFlds(array('ID', 'OrderingReason'));
        $Obj->addOrderFlds('OrderingReason', 'ASC');
    ...
    public static function getDataByID($ID)
    {
        $Obj = new SqlManager();
        $Obj->addTbls('OrderingReason');
        $Obj->addFlds(array('ID', 'OrderingReason', 'Description'));
    ...
    public static function isExists($Row)
    {
        ...
        $Obj->addFldCond('OrderingReason', $Row['OrderingReason']);    
        $Obj->addFldCond('Flag', 'R', '!=');
	...
	public static function getDataTblListCount($SearchTxt) 
	{
		...
		$Obj->addFldCond('Flag', 'R', '!=');
		if ($SearchTxt != '') {
			$Obj->addFldCond('OrderingReason', "%{$SearchTxt}%", 'LIKE', 'AND', '(');
