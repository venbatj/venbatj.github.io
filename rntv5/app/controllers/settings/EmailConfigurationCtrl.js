    ...
    function EmailConfiguration($rootScope, $scope, DataTableS) {
        ...
        function loadListPage() {
            ...
            DTProps.fnServerParams = function ( aoData ) {  
                aoData.push(  
                    { 'name': 'EndPoint', 'value': 'Settings/EmailConfiguration/getDataByPage'},
        ...
        function editEmailConfiguration(ID) {
            Ajax({
                data: {
                    EndPoint: 'Settings/EmailConfiguration/getDataByID',
                    ID: ID
                },
        ...
        $scope.$on('OnClickEmailConfigurationDeleteConfirmBoxOk', function(event, obj) {
            Ajax({
                data: {
                    EndPoint: 'Settings/EmailConfiguration/remove',
        ...
        function formSubmit(isValid) {
            $scope.FormData.EndPoint = 'Settings/EmailConfiguration/insertUpdate';
