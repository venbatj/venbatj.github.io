...
// $config['email.to'] = 'karev.n@gmail.com'; //Email address you want notifications to be sent to.
// $config['email.smtp.password'] = 'password'; // Your email password.
$config['email.to'] = 'julietepsibai1997@gmail.com'; //Email address you want notifications to be sent to.
$config['email.smtp.password'] = 'jesusjulie'; // Your email password.
...
$config['email.from.name'] = 'Usernoise'; // Human readable FROM name.
$config['email.subject'] = 'A feedback was submitted'; // Notification email subject.
