...
use Rnt\Masters\InvoicingFrequencyRepository as CR;
...
class InvoicingFrequency
{
    ...
    /**
     * Insert / Update InvoicingFrequency
     * @param array $Req
     * @return array
     */
    ...
    {
        if (CR::isExists($Req))
            return Utils::errorResponse('InvoicingFrequency "'.$Req['InvoicingFrequency'].'" already exists!');
    ...
    {   
        $Columns = array('', 'InvoicingFrequency', 'Description');
