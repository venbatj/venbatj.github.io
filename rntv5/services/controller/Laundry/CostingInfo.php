...
use Rnt\Laundry\CostingInfoRepository as CSIR;
...
class CostingInfo
{
    ...
    {   
        ...
        $RowCount = CSIR::getDataTblListCount($Req['LaundryID'], $Attributes['DataTableSearch']);
		$ResData  = CSIR::getDataTblList($Req['LaundryID'], $Attributes['StartIndex'], $Attributes['Limit'], $Attributes['DataTableSearch'], $Attributes['DataTableOrderCol'], $Attributes['DataTableOrderBy']);
