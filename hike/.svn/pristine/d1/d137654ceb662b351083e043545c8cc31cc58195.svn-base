        ...
        this.autoResume = function(b) {
            ...
            if (h.find("html").on(a.interrupt, function(a) {
                ...
                for (var y = a.windowInterrupt.split(" "), z = function() {
                        w.interrupt()
                    }, A = 0; A < y.length; A++) k.addEventListener ? (k.addEventListener(y[A], z, !1), g.$on("$destroy", function() {
                    k.removeEventListener(y[A], z, !1)
                })) : (k.attachEvent(y[A], z), g.$on("$destroy", function() {
                    k.detachEvent(y[A], z)
                }));
            var B = function(a) {
            ...
            return k.addEventListener ? (k.addEventListener("storage", B, !1), g.$on("$destroy", function() {
                k.removeEventListener("storage", B, !1)
            })) : k.attachEvent && (k.attachEvent("onstorage", B), g.$on("$destroy", function() {
