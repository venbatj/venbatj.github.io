...
(function() {
    ...
    function Menu($rootScope, $scope, DataTableS) {
        ...
        function loadListPage() {
            ...
            DTProps.fnServerParams = function(aoData) {  
                aoData.push(  
                    { 'name': 'EndPoint', 'value': 'Settings/Menu/getDataByPage'},
        ...
        function editMenu(ID) {
            Ajax({
                data: {
                    EndPoint: 'Settings/Menu/getDataByID',
                    ID: ID
                },
    ...
    function loadMenuDropdown() {            
        Ajax({
            data: {
                EndPoint: 'Settings/Manu/getAllData'
            },
            success: function(Res) {
    ...
    function onMenuChange() {
        ...
        function formSubmit(isValid) {
            $scope.FormData.EndPoint = 'Settings/Menu/insertUpdate';
