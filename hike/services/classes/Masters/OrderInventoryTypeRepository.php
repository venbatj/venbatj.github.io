...
/**
 * OrderInventoryTypeRepository
 * 
 * @package Rnt\Masters
 */
class OrderInventoryTypeRepository implements IRepository
{
    use AERRepository;
    ...
    {
        $Obj = new SqlManager();
        $Obj->addTbls('OrderType');
        $Obj->addFlds(array('ID', 'OrderType'));
        $Obj->addOrderFlds('OrderType', 'ASC');
    ...
    public static function getDataByID($ID)
    {
        $Obj = new SqlManager();
        $Obj->addTbls('OrderType');
        $Obj->addFlds(array('ID', 'OrderType', 'Description'));
    ...
    public static function isExists($Row)
    {
        ...
        $Obj->addFldCond('OrderType', $Row['OrderType']);    
        $Obj->addFldCond('Flag', 'R', '!=');
